//From Lea • https://github.com/LeaPhant/skyblock-stats/tree/master/src/constants

const max_fairy_souls = 209;
const item_types = [
  "sword",
  "bow",
  "fishing rod",
...
const talisman_duplicates = {};

// Minecraft color and formatting codes
const minecraft_color_formatting = {
  0: {
    type: "color",
    color: "#000000",
    css: "color: #000000",
